...
contract Orchestrator is Ownable {
    ...
    ICoreOrchestrator private coreOrchestrator;
    ...
    constructor(
        ...
        coreOrchestrator = ICoreOrchestrator(_coreOrchestrator);

        admin = _admin;
    }

    function initCore() public onlyOwner {
        (core, tribe, fei, tribeSupply) = coreOrchestrator.init(admin);
    }
    ...
    function initTimelocks() public onlyOwner {
        uint256 length = TRIBE_TIMELOCK_AMTS.length;
        timelockedDelegators = idoOrchestrator.initTimelocks(
            timelockedDelegator,
            admin,
            tribe,
            TOKEN_TIMELOCK_RELEASE_WINDOW,
